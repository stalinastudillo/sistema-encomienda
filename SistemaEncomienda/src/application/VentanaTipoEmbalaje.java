...
public class VentanaTipoEmbalaje extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		stageI = primaryStage;
		stageI.setTitle("TIPO EMBALAJE");
		//IdentVentana = "TIPO EMBALAJE";
		ContextoEncomienda.getInstance().setIdentificadorVentana("TIPO EMBALAJE");
