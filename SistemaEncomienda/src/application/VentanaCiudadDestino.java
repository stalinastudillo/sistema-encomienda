...
public class VentanaCiudadDestino extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		stageI = primaryStage;
		stageI.setTitle("CIUDAD DESTINO");
		ContextoEncomienda.getInstance().setIdentificadorVentana("CIUDAD DESTINO");
